...
Além disso, quando criar esse novo arquivo, também se faz um arquivo de extensão *.h* com todas as funções do programa (menos a main). <br> Esse arquivo *.h* deve fazer parte dos includes dos outros 2 arquivos e entre aspas duplas, pois o pré-processador procura pelo arquivo especificado no diretório atual do arquivo fonte que está sendo compilado.
